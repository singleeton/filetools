...
export const tools: Tool[] = [
  { id: 'pdf-merge', name: 'PDF Merge', description: 'Combine multiple PDF files into one document', href: '/pdf-merge', category: 'pdf', icon: 'Merge', screenshot: '/screenshots/pdf-merge.png', screenshotLocales: { en: '/screenshots/pdf-merge-en.png', ru: '/screenshots/pdf-merge-ru.png', zh: '/screenshots/pdf-merge-zh.png' }, isPopular: true },
  ...
  { id: 'remove-bg', name: 'Remove Background', description: 'Remove background with interactive editor', href: '/remove-bg', category: 'image', icon: 'Eraser', screenshot: '/screenshots/remove-bg.png', screenshotLocales: { en: '/screenshots/remove-bg-en.png', ru: '/screenshots/remove-bg-ru.png', zh: '/screenshots/remove-bg-zh.png' }, isPopular: true },
]
