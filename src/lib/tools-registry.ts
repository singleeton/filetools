...
export const tools: Tool[] = [
  { id: 'pdf-merge', name: 'PDF Merge', description: 'Combine multiple PDF files into one document', href: '/pdf-merge', category: 'pdf', icon: 'Merge', screenshot: '/screenshots/pdf-merge.png' },
  { id: 'pdf-split', name: 'PDF Split', description: 'Split a PDF file into separate pages or sections', href: '/pdf-split', category: 'pdf', icon: 'Scissors', screenshot: '/screenshots/pdf-split.png' },
  ...
  { id: 'remove-bg', name: 'Remove Background', description: 'Remove background with interactive editor', href: '/remove-bg', category: 'image', icon: 'Eraser', screenshot: '/screenshots/remove-bg.png' },
]
