...
export const tools: Tool[] = [
  ...
  { id: 'pdf-compress', name: 'PDF Compress', description: 'Reduce PDF file size without losing quality', href: '/pdf-compress', category: 'pdf', icon: 'FileDown' },
  ...
  { id: 'remove-bg', name: 'Remove Background', description: 'Remove image background', href: '/remove-bg', category: 'image', icon: 'Eraser' },
]
