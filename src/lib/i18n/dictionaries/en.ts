export const en = {
  ...
  split: {
    ...
    pageRangeDesc: 'Extract a range of pages',
    extractPages: 'Extract Specific Pages',
    extractPagesDesc: 'Enter page numbers separated by commas (e.g. 1, 3, 5)',
    allPages: 'All Pages',
    allPagesDesc: 'Keep all pages (useful for removing encryption)',
    button: 'Split PDF',
    from: 'From',
    to: 'to',
  },
