...
export const tr: Dictionary = {
  ...
  pageEditor: {
    ...
    summary: {
      selectedCount: 'Seçili Sayfa',
      outputCount: 'Çıktı Dosyası',
    ...
    shortcuts: {
      ...
      undoHint: 'Ctrl+Z: son değişikliği geri alır',
    },
  },
