...
export interface PdfProcessingStepsLabels {
  reading: string
  preparing: string
  creating: string
  done: string
...
interface PdfProcessingStepsProps {
  phase: ProcessingPhase
  labels: PdfProcessingStepsLabels
}

export function PdfProcessingSteps({ phase, labels }: PdfProcessingStepsProps) {
